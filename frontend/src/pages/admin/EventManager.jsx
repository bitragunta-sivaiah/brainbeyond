...
import { Plus, Edit, Trash2, Calendar, MapPin, Globe, Clock, X, CloudUpload } from 'lucide-react';
...
import {
  ...
  updateEvent,
  deleteEvent,
} from '../../store/redux/eventSlice';
import { uploadSingleFile, clearSingleFileUpload } from '../../store/redux/uploadSlice';
...
const EventModal = ({ event, onClose, onSave, isEditing }) => {
  ...
  // CORRECTED: Access fileUrl from the singleFile object
  useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    // CORRECTED: Ensure image is included in formattedData
    const formattedData = {
      ...formData,
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            type="submit"
            className="w-full py-3 mt-4 text-white font-semibold rounded-md bg-primary hover:bg-primary/90 transition-colors"
