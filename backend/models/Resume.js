...
const resumeSchema = new mongoose.Schema({
    ...
    sectionOrder: [{
        type: String,
        // FIX: Add 'contact' to the list of allowed enum values
        enum: ['contact', 'summary', 'workExperience', 'education', 'projects', 'skills', 'certifications', 'achievements', 'customSections']
    }],
